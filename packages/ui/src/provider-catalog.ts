...
export const providerCatalog: ProviderCatalogEntry[] = [
  ...
  },
  {
    id: "cursor",
    displayName: "Cursor",
    apiKeyRef: "provider-cli:cursor-agent",
    enabled: false,
    authMode: "cli",
    authStatus: "not-connected",
    baseUrl: null,
    ...
    models: [
      {
        ...
        description: "Uses the model configured in your local Cursor CLI.",
      },
    ],
    effort: "medium",
    allowedTools: ["files", "terminal", "diff"],
  },
  {
    ...
    apiKeyRef: "provider-cli:opencode",
    enabled: false,
    authMode: "cli",
    authStatus: "not-connected",
    baseUrl: null,
    ...
    models: [
      {
        ...
        description: "Uses the model configured in your local OpenCode CLI.",
      },
    ],
    effort: "medium",
    allowedTools: ["files", "terminal", "diff"],
