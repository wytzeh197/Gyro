...
The captures use Gyro's real light interface, an isolated demo repository, and
a fake local provider. No real provider traffic, account data, private
repository content, or testimonials appear in these images. Optimized WebP
derivatives live under `site/assets/screenshots/`.
