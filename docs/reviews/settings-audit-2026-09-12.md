...
![General, initial review](../screenshots/settings-audit-2026-09-12/01-general.png)
...
![Appearance, initial review](../screenshots/settings-audit-2026-09-12/02-appearance.png)
...
![Keyboard, initial review](../screenshots/settings-audit-2026-09-12/03-keyboard.png)
...
![Usage Limits, initial review](../screenshots/settings-audit-2026-09-12/04-usage.png)
...
![Providers, initial review](../screenshots/settings-audit-2026-09-12/05-providers.png)
...
![CLI Profiles, initial review](../screenshots/settings-audit-2026-09-12/06-cli.png)
...
![Permissions, initial review](../screenshots/settings-audit-2026-09-12/07-permissions.png)
...
![Editor & Search, initial review](../screenshots/settings-audit-2026-09-12/08-editor.png)
...
![Tools & Contributions, initial review](../screenshots/settings-audit-2026-09-12/09-tools.png)
...
![Updates, initial review](../screenshots/settings-audit-2026-09-12/10-updates.png)
...
![Advanced, initial review](../screenshots/settings-audit-2026-09-12/11-advanced.png)
...
![Help, initial review](../screenshots/settings-audit-2026-09-12/12-help.png)

## Verified fixes

![Focused composer without blue border](../screenshots/settings-audit-2026-09-12/14-composer-focused-fixed.png)

![Editor values retained after navigation](../screenshots/settings-audit-2026-09-12/15-editor-fixed.png)

![Advanced settings at 860×620](../screenshots/settings-audit-2026-09-12/13-advanced-fixed-compact.png)
